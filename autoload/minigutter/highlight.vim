function! minigutter#highlight#line_disable() abort
  let g:minigutter_highlight_lines = 0
...
function! minigutter#highlight#line_enable() abort
  let old_highlight_lines = g:minigutter_highlight_lines

  let g:minigutter_highlight_lines = 1
  call s:define_sign_line_highlights()

  if !old_highlight_lines && !g:minigutter_signs
...
function! minigutter#highlight#line_toggle() abort
  if g:minigutter_highlight_lines
    call minigutter#highlight#line_disable()
  else
    call minigutter#highlight#line_enable()
  endif
endfunction


function! minigutter#highlight#define_sign_column_highlight() abort
  if g:minigutter_override_sign_column_highlight
...
function! minigutter#highlight#define_highlights() abort
...
function! minigutter#highlight#define_signs() abort
...
function! s:define_sign_text() abort
  execute "sign define GitGutterLineAdded            text=" . g:minigutter_sign_added
  execute "sign define GitGutterLineModified         text=" . g:minigutter_sign_modified
  execute "sign define GitGutterLineRemoved          text=" . g:minigutter_sign_removed
  execute "sign define GitGutterLineRemovedFirstLine text=" . g:minigutter_sign_removed_first_line
  execute "sign define GitGutterLineModifiedRemoved  text=" . g:minigutter_sign_modified_removed
endfunction

function! minigutter#highlight#define_sign_text_highlights() abort
