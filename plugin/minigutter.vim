...
function! s:diffmode(line) abort
    ...
    if from_count == 0 && to_count > 0
      return s:s_process_added(from_count, to_count, to_line)
    elseif from_count > 0 && to_count == 0
      return s:s_process_removed(from_count, to_count, to_line)
    elseif from_count > 0 && to_count > 0 && from_count == to_count
      return s:s_process_modified(from_count, to_count, to_line)
    elseif from_count > 0 && to_count > 0 && from_count < to_count
      return s:s_process_modified_and_added(from_count, to_count, to_line)
    elseif from_count > 0 && to_count > 0 && from_count > to_count
      return s:s_process_modified_and_removed(from_count, to_count, to_line)
    endif
endfunction
